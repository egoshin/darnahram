...
<?foreach($arResult["ITEMS"] as $arItem):?>
	...
	?>
	<div class="bx-newslist-container col-xs-12 col-sm-6 col-md-4" id="<?=$this->GetEditAreaId($arItem['ID']);?>">
		...
		<div class="row">
			<?if($arParams["DISPLAY_DATE"]!="N" && $arItem["DISPLAY_ACTIVE_FROM"]):?>
				<div class="col-xs-12 text-right">
					<div class="bx-newslist-date"><i class="fa fa-calendar"></i>&nbsp;&nbsp;<?echo $arItem["DISPLAY_ACTIVE_FROM"]?></div>
				</div>
			<?endif?>
		</div>
